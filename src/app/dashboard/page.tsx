...
const CircularProgress = ({ percentage }: { percentage: number }) => {
  ...
  return (
    <div className="relative flex items-center justify-center w-24 h-24">
      <svg className="w-full h-full transform -rotate-90 drop-shadow-[0_0_8px_rgba(244,63,94,0.4)] dark:drop-shadow-[0_0_8px_rgba(204,255,0,0.4)]" viewBox="0 0 100 100">
        <circle
        ...
        />
        <circle
          className="text-rose-500 dark:text-[#ccff00] transition-all duration-1000 ease-out"
          strokeWidth="8"
      ...
      <div className="absolute inset-0 flex items-center justify-center flex-col">
        <span className="text-xl font-black text-purple-950 dark:text-white drop-shadow-[0_0_8px_rgba(244,63,94,0.5)] dark:drop-shadow-[0_0_8px_rgba(204,255,0,0.5)]">
          {percentage}%
        </span>
      </div>
    </div>
        ...
        <div className="md:col-span-2 bg-white/80 dark:bg-[#1a0b2e]/80 backdrop-blur-md p-6 rounded-2xl border border-purple-200 dark:border-purple-800/50 shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:shadow-[0_0_20px_rgba(138,43,226,0.1)]">
          <div className="flex items-center justify-between mb-6">
            <h2 className="text-2xl font-black text-purple-950 dark:text-white uppercase flex items-center gap-2">
              <Trophy className="text-rose-500 dark:text-[#ccff00]" /> Leaderboard
            </h2>
          </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {leaderboard.length > 0 ? leaderboard.map((player, idx) => (
                <div key={idx} className="flex items-center p-4 bg-purple-50 dark:bg-purple-900/20 rounded-xl border border-purple-100 dark:border-purple-800/50 hover:border-rose-500 dark:hover:border-[#ccff00] transition-all duration-300 group hover:shadow-[0_0_15px_rgba(244,63,94,0.2)] dark:hover:shadow-[0_0_15px_rgba(204,255,0,0.2)] hover:-translate-y-1 cursor-default">
        ...
        <div className="lg:col-span-2 bg-white/80 dark:bg-[#1a0b2e]/80 rounded-2xl border border-purple-200 dark:border-purple-800/50 shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-6">
          ...
          <div className="space-y-4">
            {tabunganLeaderboard.length > 0 ? tabunganLeaderboard.map((item, idx) => (
              <div key={idx} className="flex items-center p-4 border border-purple-100 dark:border-purple-800/50 rounded-xl hover:border-rose-500 dark:hover:border-[#ccff00] transition-all duration-300 group bg-purple-50 dark:bg-purple-900/10 hover:shadow-[0_0_15px_rgba(244,63,94,0.2)] dark:hover:shadow-[0_0_15px_rgba(204,255,0,0.2)] hover:-translate-y-1 cursor-default">
                <div className="font-black text-xl w-8 text-purple-400 dark:text-purple-600 drop-shadow-[0_2px_2px_rgba(0,0,0,0.5)]">#{idx + 1}</div>
                <div className="flex-1 ml-2">
                  <h4 className="text-md font-bold text-purple-950 dark:text-white group-hover:text-rose-500 dark:group-hover:text-[#ccff00] transition-colors">{item.nama}</h4>
                ...
                <div className="text-right">
                  ...
                  <p className="text-md font-black text-rose-500 dark:text-[#ccff00]">
          ...
          <div className="space-y-4 relative before:absolute before:inset-0 before:ml-2 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-purple-300 dark:before:via-purple-800 before:to-transparent">
            {agenda.length > 0 ? agenda.map((item, i) => (
              <div key={i} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
                <div className="flex items-center justify-center w-4 h-4 rounded-full border border-white dark:border-[#0a0014] bg-purple-300 dark:bg-purple-800 group-[.is-active]:bg-rose-500 dark:group-[.is-active]:bg-[#ccff00] group-[.is-active]:shadow-[0_0_10px_rgba(244,63,94,0.8)] dark:group-[.is-active]:shadow-[0_0_10px_rgba(204,255,0,0.8)] shadow shrink-0 md:order-1 md:group-odd:-translate-x-1/2 md:group-even:translate-x-1/2 transition-all" />
                <div className="w-[calc(100%-2rem)] md:w-[calc(50%-1.5rem)] p-3 rounded-xl border border-purple-200 dark:border-purple-800/50 shadow-sm ml-4 md:ml-0 bg-white dark:bg-purple-900/20 group-hover:border-rose-400 dark:group-hover:border-[#ccff00]/50 transition-colors">
