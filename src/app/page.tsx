...
export default function LandingPage() {
  ...
  return (
    <div className="bg-[#050B14] min-h-screen text-slate-200 overflow-x-hidden selection:bg-emerald-500/30">
      <audio ref={audioRef} src="https://cdn.pixabay.com/download/audio/2022/02/10/audio_f559286c47.mp3?filename=forest-campfire-113644.mp3" loop muted={isMuted} />
      ...
      <section className="relative h-screen flex flex-col items-center justify-center overflow-hidden">
        <motion.div style={{ y: yBg }} className="absolute inset-0 z-0 opacity-40">
          <img src="/jungle_bg.png" alt="Jungle" className="w-full h-full object-cover" />
        </motion.div>
        ...
        <motion.div 
          ...
          className="absolute bottom-10 z-20 text-emerald-500 opacity-70"
        >
          ...
          <div className="grid md:grid-cols-2 gap-12">
            ...
            >
              ...
              <div className="relative aspect-square w-full mb-8 rounded-2xl overflow-hidden bg-gradient-to-b from-slate-800 to-[#0f1c2e]">
                <img src="/scout_boy.png" alt="Boy Scout with Bow" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
            ...
            >
              ...
              <div className="relative aspect-square w-full mb-8 rounded-2xl overflow-hidden bg-gradient-to-b from-slate-800 to-[#0f1c2e]">
                <img src="/scout_girl.png" alt="Girl Scout with Kujang" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
                <div className="absolute inset-0 bg-gradient-to-t from-[#0f1c2e] via-transparent to-transparent" />
              </div>
